...
namespace FronkonGames.Artistic.ColorIsolation
{
  ...
  {
    private static ColorIsolation renderFeature;
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is ColorIsolation)
                renderFeature = scriptableRendererData.rendererFeatures[i] as ColorIsolation;
            }
          }
        }
